...
def start_hand_detection():
    ...
    offset = 30
    imgSize = 500
    labels = ["This is", "Our", "Sign Detect", "Project", "CodeCrafters", "Hello", "Ok"]
    ...
    def update_frame():
        ...
        if hands:
          ...
          # Create a black image instead of a white one
          ...
          textPosition = (10, 30)  # Example position, adjust as necessary

          # Add the hand type text to the image with black color
          font = cv2.QT_FONT_BLACK
          fontScale = 1
          fontColor = (0, 0, 0)  # Black color in BGR
          lineType = 2
          cv2.putText(imgblack, handType, textPosition, font, fontScale, fontColor, lineType)
...
def main():
    ...
    background_image = Image.open(r"E:/Final_Project/004.png")
    ...
    back_button = tk.Button(button_frame, text="Back", command=go_back, bg="#FFC107", fg="white", font=("Helvetica", 14))
